...
class UIColor
{
	...
	static int Orange() 			  { return ARGB(255, 212, 194, 19); };
...
class colorScheme 
{
	...
	// Shader Colors 
	static int TopShader()       	  { return UIColor.Orange(); };
	static int BottomShader()    	  { return UIColor.Grey(); };
	...
	static int SurvivorBox()       	  { return UIColor.Orange(); };
	static int StatsBox()     	 	  { return UIColor.Grey(); };
